...
class NearParabolic extends Target
{
     ...
     * @return float The magnitude, 99.9 when the photometric parameters are not known
     */
     ...
     * Chapters 33 and 35 of Astronomical Algorithms.
     *
     * @param  Carbon  $date  The date
     * @return array [x, y, z]
     */
    protected function _heliocentricRectangularCoordinates(Carbon $date): array
    {
